...
exports.getTopVideos = exports.getOne = exports.getAll = exports.updateOne = exports.removeOne = exports.addOne = void 0;
...
var addOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newRecord = new video_1["default"](__assign(__assign({}, req.body), { createdBy: req.user.id }));
...
var removeOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, video_1["default"].findByIdAndDelete(req.params.id)];
            case 1:
                deleted = _a.sent();
                if (!deleted) {
...
var updateOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, video_1["default"].findByIdAndUpdate(req.params.id, req.body)];
            case 1:
                _a.sent();
                return [2 /*return*/, res.status(201).json({
...
var getOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, video_1["default"].findByIdAndUpdate(req.params.id, {
                        $inc: { viewsCount: 1 }
                    })];
            case 1:
                item = _a.sent();
...
var getTopVideos = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, video_1["default"].find({})
                        .sort({ viewsCount: -1 })
                        .limit(3)
                        .lean()
                        .exec()];
